...
type MemcachedSpec struct {
	...
	// Represents the current applications current replica size.
	//+operator-sdk:csv:customresourcedefinitions:type=spec,order=98,displayName="Number of pods",xDescriptors={"urn:alm:descriptor:com.tectonic.ui:podCount","urn:alm:descriptor:io.kubernetes:custom"}
...
type MemcachedStatus struct {
	...
	//+operator-sdk:csv:customresourcedefinitions:type=status,order=99,xDescriptors={"urn:alm:descriptor:io.kubernetes.conditions"}
	Conditions []metav1.Condition `json:"conditions"`

	// ApplicationsStatus Status of the ELM applications
	//+operator-sdk:csv:customresourcedefinitions:type=status,order=92,displayName="Applications Status"
	ApplicationsStatus ApplicationsStatus `json:"applicationsStatus"`
